  ...
  class Counter extends ExprTransform {
    ...
    def transform(e: Expr) = {
      ...
      e match {
        ...
        case e: Expr.ObjBody.MemberList =>
          ...
          else if(e.binds == null && e.asserts == null && e.fields.forall(_.isSimple)) simpleObjs += 1
          else otherObjs += 1
        case _ =>
      }
      rec(e)
    ...
    override def toString =
      s"Total: $total, Val: $vals, Expr: $exprs, Val.Arr: $arrVals, static Expr.Arr: $staticArrExprs, "+
        ...
        s"simple MemberList: $simpleObjs other MemberList: $otherObjs"
  }
}
