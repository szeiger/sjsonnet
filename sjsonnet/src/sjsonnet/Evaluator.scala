...
class Evaluator(resolver: CachedResolver,
  ...
  def visitExpr(e: Expr)(implicit scope: ValScope): Val = try {
    e.eid match {
      case Expr.EID_ValidId => visitValidId(e.asInstanceOf[ValidId])
      case Expr.EID_BinaryOp => visitBinaryOp(e.asInstanceOf[BinaryOp])
      case Expr.EID_Select => visitSelect(e.asInstanceOf[Select])
      case Expr.EID_Val => e.asInstanceOf[Val]
      case Expr.EID_ApplyBuiltin1 => visitApplyBuiltin1(e.asInstanceOf[ApplyBuiltin1])
      case Expr.EID_ApplyBuiltin2 => visitApplyBuiltin2(e.asInstanceOf[ApplyBuiltin2])
      case Expr.EID_And => visitAnd(e.asInstanceOf[And])
      case Expr.EID_Or => visitOr(e.asInstanceOf[Or])
      case Expr.EID_UnaryOp => visitUnaryOp(e.asInstanceOf[UnaryOp])
      case Expr.EID_Apply1 => visitApply1(e.asInstanceOf[Apply1])
      case Expr.EID_Lookup => visitLookup(e.asInstanceOf[Lookup])
      case Expr.EID_Function => val e2 = e.asInstanceOf[Function]; visitMethod(e2.body, e2.params, e2.pos)
      case Expr.EID_LocalExpr => visitLocalExpr(e.asInstanceOf[LocalExpr])
      case Expr.EID_Apply => visitApply(e.asInstanceOf[Apply])
      case Expr.EID_IfElse => visitIfElse(e.asInstanceOf[IfElse])
      case Expr.EID_Apply3 => visitApply3(e.asInstanceOf[Apply3])
      case Expr.EID_MemberList => visitMemberList(e.pos, e.asInstanceOf[ObjBody.MemberList], null)
      case Expr.EID_Apply2 => visitApply2(e.asInstanceOf[Apply2])
      case Expr.EID_AssertExpr => visitAssert(e.asInstanceOf[AssertExpr])
      case Expr.EID_ApplyBuiltin => visitApplyBuiltin(e.asInstanceOf[ApplyBuiltin])
      case Expr.EID_Comp => visitComp(e.asInstanceOf[Comp])
      case Expr.EID_Arr => visitArr(e.asInstanceOf[Arr])
      case Expr.EID_SelectSuper => visitSelectSuper(e.asInstanceOf[SelectSuper])
      case Expr.EID_LookupSuper => visitLookupSuper(e.asInstanceOf[LookupSuper])
      case Expr.EID_InSuper => visitInSuper(e.asInstanceOf[InSuper])
      case Expr.EID_ObjExtend => visitObjExtend(e.asInstanceOf[ObjExtend])
      case Expr.EID_ObjComp => visitObjComp(e.asInstanceOf[ObjBody.ObjComp], null)
      case Expr.EID_Slice => visitSlice(e.asInstanceOf[Slice])
      case Expr.EID_Import => visitImport(e.asInstanceOf[Import])
      case Expr.EID_Apply0 => visitApply0(e.asInstanceOf[Apply0])
      case Expr.EID_ImportStr => visitImportStr(e.asInstanceOf[ImportStr])
      case Expr.EID_Error => visitError(e.asInstanceOf[Expr.Error])
